...
namespace NutrInfo.Admin.Api.Configuration
{
    public static class SwaggerConfiguration
    {
        const string Title = "NutrInfo Admin API";
        const string Description = "NutrInfo Admin API V1";
        ...
        public static void AddSwaggerDocumentation(this IServiceCollection services)
        {
            ...
            {
                var xmlComments = Path.Combine(AppContext.BaseDirectory, "NutrInfo.Admin.Api.xml");
